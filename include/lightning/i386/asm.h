...
#define _D64(D)         (_jit_L(0), ((*(_PUL(_jit.x.pc) - 1))= _OFF8(D))) // TODO
...
#define __REXwrxb(L,W,R,X,B)	((W|R|X|B) || (L) ? _d64(W,R,X,B) : (0))
...
/* N byte NOPs */
#define NOPi(N)		(((  (N)    >= 8) ? (_jit_B(0x8d),_jit_B(0xb4),_jit_B(0x26),_jit_I(0x00),_jit_B(0x90)) :  0), \
...
#if defined (__i386__)
# include <lightning/i386/x86/asm.h>
#else
# include <lightning/i386/x86_64/asm.h>
#endif

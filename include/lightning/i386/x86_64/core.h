...
#define jit_finishr(reg)	((jit_reg_is_arg((reg)) ? MOVQrr(reg, JIT_REXTMP) : 0), \
                                 jit_shift_args(), \
...
#define jit_retval_l(rd)	(jit_movr_l ((rd), _EAX))
...
#define jit_movr_l(d, rs)	(((rs) == (d) ? 0 : MOVQrr((rs), (d))))
